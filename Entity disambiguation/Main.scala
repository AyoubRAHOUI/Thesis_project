...
object Main {
  ...
  def main(args : Array[String]): Unit = {
    ...
    val g: Graph[String, String] = ReadGraph.getGraph(args(0), sc)

    println("geting aliases")
    val aliasSep= GraphProp.aliasSep
    val edgeLabelNodeAlias = GraphProp.edgeLabelNodeAlias.toArray
    val verticesWithAlias = NodeProp.constructVertexRDDWithAlias(g, aliasSep, edgeLabelNodeAlias)
